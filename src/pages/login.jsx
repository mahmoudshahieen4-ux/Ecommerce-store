...
export default function Login() {
    ...
    return (
        <main className="w-screen min-h-screen  pt-30 pb-5 flex justify-center items-center">
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-6">
                    ...
                    <div className="flex-col sm:flex-row flex sm:items-center justify-between">
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="rememberMe" className="ml-2 block text-sm text-gray-800 dark:text-gray-200">
                                Remember me
                            </label>
                        </div>
