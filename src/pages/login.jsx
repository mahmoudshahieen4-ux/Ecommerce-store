        ...
        <main className="w-screen min-h-screen bg-gradient-to-br from-red-600 via-orange-500 to-orange-400 pt-30 pb-5 flex justify-center items-center">
            <div className="container max-w-md w-full bg-white dark:bg-black shadow-2xl p-3 sm:p-8 rounded-lg sm:rounded-2xl border border-white">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-700 dark:text-gray-200">Please enter your details to sign in</p>
                </div>
                ...
                <form action="#" method="POST" className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                id="email"
                                name="email"
                                className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white/50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                id="password"
                                name="password"
                                className="block w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white/50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                    ...
                    <div className="flex-col  sm:flex-row flex sm:items-center justify-between">
                        ...
                        <div className="text-sm">
                            <a href="#" className="font-medium text-primary hover:text-dark-primary transition-colors">
                    ...
                    <div className="text-center mt-6">
                        <p className="text-sm text-gray-700 dark:text-gray-200">
                            ...
                            <Link to="/signup" className="font-medium text-primary hover:text-dark-primary transition-colors">
                                Sign up
                            </Link>
                        </p>
                    </div>
